...
echo "  zip -r CrashReporter.xcframework.zip Vendor/PLCrashReporter/CrashReporter.xcframework"
echo ""
echo "Then update Package.swift with the new URLs and checksums."
