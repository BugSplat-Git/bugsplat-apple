...
- Download BugSplat's cross-platform tool `symbol-upload-macos`. See  our [documentation](https://docs.bugsplat.com/education/faq/how-to-upload-symbol-files-with-symbol-upload) to download and learn more about how to use symbol-upload-macos.
