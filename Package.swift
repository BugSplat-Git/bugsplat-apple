...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "BugSplat",
            url: "https://github.com/BugSplat-Git/bugsplat-apple/releases/download/3.8.0/BugSplat.xcframework.zip",
            checksum: "0f6fb57d8903d5472452833c7263d6f979f9786b2a7956474efda905dfb8f0e3"
        ),
