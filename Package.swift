...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "BugSplat",
            url: "https://github.com/BugSplat-Git/bugsplat-apple/releases/download/v3.3.0/BugSplat.xcframework.zip",
            checksum: "6acbc8368d6ad8739726db91279900cd6425a7cb8543042f0756c40353b8a069"
        ),
