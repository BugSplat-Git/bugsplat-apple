...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "BugSplat",
            url: "https://github.com/BugSplat-Git/bugsplat-apple/releases/download/3.5.0/BugSplat.xcframework.zip",
            checksum: "4ab5192a083017d3a13bd942dbc6851b3af495f2e7466eecdebd85f3073db26d"
        ),
