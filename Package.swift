...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BugSplat",
            url: "https://github.com/BugSplat-Git/bugsplat-apple/releases/download/v1.0.0/BugSplat.xcframework.zip",
            checksum: "9e80cf8f47aa573ead9f5cb1f0677304aaca141f5eed098be910e947483cc892"
        ),
